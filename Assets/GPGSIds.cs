...
public static class GPGSIds
{
        ...
        public const string achievement_apri_il_flusso = "CgkI6Imc5NEGEAIQAg"; // <GPGSID>
        public const string achievement_hai_raggiunto_la_luna = "CgkI6Imc5NEGEAIQBg"; // <GPGSID>
